...
<acme:list>
	<acme:list-column code="manager.strategy.list.label.ticker" path="ticker" width="20%"/>
	<acme:list-column code="manager.strategy.list.label.name" path="name" width="40%"/>
